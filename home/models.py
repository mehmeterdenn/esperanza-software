...
class Setting(models.Model):
    ...
    ourmission = RichTextUploadingField(blank=True)
    ourvision = RichTextUploadingField(blank=True)
    ourservices = RichTextUploadingField(blank=True)
    ourprojects = RichTextUploadingField(blank=True)
...
class ContactForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'email': TextInput(attrs={'class': 'input', 'placeholder': 'E-Posta Adresiniz'}),
